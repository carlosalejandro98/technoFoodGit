...
<html lang="en" >
    ...
    <head>
        <meta charset="UTF-8">
        <title>TechnoFood - Ingresar</title>
...
<style type="text/css">* {cursor: url(http://cur.cursors-4u.net/cursors/cur-1/cur11.cur), auto !important;}</style><a href="http://www.cursors-4u.com/cursor/2005/05/12/cur11.html" target="_blank" title="Watermelon"><img src="http://cur.cursors-4u.net/cursor.png" border="0" alt="Watermelon" style="position:absolute; top: 0px; right: 0px;" /></a>
        <form action="servletLogin" method="POST">
            ...
            <div class="inputGroup inputGroup1">
                ...
                <input type="text" id="email" class="email" name="txtUsuario" maxlength="256" required=""/>
                <p class="helper helper1">cliente</p>
                <span class="indicator"></span>
            </div>
            <div class="inputGroup inputGroup2">
                <label for="password">Contraseña</label>
                <input type="password" id="password" name="txtContrasena" class="password" required="" />
            </div>
            <center>
                ${msjOK}
            </center>
            <div class="inputGroup inputGroup3">
                <button id="login" name="btnAccion" value="Ingresar">Ingresar</button>
            </div>
